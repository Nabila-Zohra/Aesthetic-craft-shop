...
<head>
    ...
    <body>
        ...
        <div class="subbox">
            ...
            <form action="searchArtCraft.php" method = "post">
        ...
        $code = $_POST['code'];
        $result = mysqli_query($con,"SELECT * FROM `artcraft` WHERE `code`='$code'");
      ...
      $result = mysqli_query($con,"SELECT * FROM `artcraft`");
      while($row = mysqli_fetch_assoc($result)){
          ...
          <div class='details'>".
          "<div class='nameArt'>" .$row['name']."</div>
