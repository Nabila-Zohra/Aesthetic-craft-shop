...
<head>
    ...
    <body>
        ...
        <div class="subbox">
            ...
            <form action="searchStampCraft.php" method = "post">
        ...
        $code = $_POST['code'];
        $result = mysqli_query($con,"SELECT * FROM `stampcraft` WHERE `code`='$code'");
      ...
      $result = mysqli_query($con,"SELECT * FROM `stampcraft`");
      while($row = mysqli_fetch_assoc($result)){
          ...
          <div class='details'>".
          "<div class='nameStamp'>" .$row['name']."</div>
